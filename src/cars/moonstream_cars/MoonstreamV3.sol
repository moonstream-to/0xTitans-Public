...
contract MoonstreamV3 is ICar {
    ...
    function updateProfile(Monaco.CarData memory carData) internal {
    ...
    function currentProfile(Monaco.CarData memory carData) internal view returns (CarProfile result) {
        address car = address(carData.car);
